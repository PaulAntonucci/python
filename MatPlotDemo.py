...
def readInputFiles():
    ...
    #del(peak_freq_ini, peak_int_ini)
...
def clearSpectrum():
    ...
    del(freq_list_ini, int_list_ini)
...
def glot():
    ...
    print("in function glot - does this print out?")
...
# Import
    ...
    print("Hey, Where's the output window????")
    # getFileName()
